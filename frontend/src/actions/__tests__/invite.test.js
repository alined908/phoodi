...
describe('Invite actions', () => {
    ...
    it ('should handle getUserFriendInvites() success', async () => {
        const expectedActions = [
            ...
            {type: types.GET_FRIEND_INVITES_SUCCESS, payload: [{...mocks.friendInvite}]}
        ]
    ...
    it ('should handle getUserFriendInvites() error', async () => {
        const expectedActions = [
            {type: types.GET_FRIEND_INVITES_REQUEST},
            {type: types.GET_FRIEND_INVITES_ERROR, payload: "Unable to get friend invites."}
        ]
    ...
    it ('should handle getUserMeetupInvites() success', async () => {
        const expectedActions = [
            ...
            {type: types.GET_MEETUP_INVITES_SUCCESS, payload: [{...mocks.friendInvite}]}
        ]
    ...
    it ('should handle getUserMeetupInvites() error', async () => {
        const expectedActions = [
            {type: types.GET_MEETUP_INVITES_REQUEST},
            {type: types.GET_MEETUP_INVITES_ERROR, payload: "Unable to get meetup invites."}
        ]
    ...
    it ('should handle sendMeetupInvite() success', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "Invite for meetup sent to daniel."}}
        ]

        mock.onPost('/api/meetups/uri/invite/').reply(200, {message: "Invite for meetup sent to daniel."})
    ...
    it ('should handle sendMeetupInvite() error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "An error occurred."}}
        ]
    ...
    it ('should handle sendFriendInvite() success', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "Invite sent to daniel."}}
        ]

        mock.onPost('/api/friends/invite/').reply(200, {message: "Invite sent to daniel."})
    ...
    it ('should handle respondMeetupInvite() success', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "accepted."}}
        ]

        mock.onPatch('/api/meetups/uri/invite/invuri/').reply(200, {message: "accepted."})
    ...
    it ('should handle respondFriendInvite() success', async () => {
        ...
        mock.onPatch('/api/friends/invite/uri/', {status: 1}).reply(200, {message: "Accepted"})
