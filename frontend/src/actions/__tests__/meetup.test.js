...
describe("Meetup actions", () => {
  ...
  it("should handle addMeetup success", async () => {
    ...
    mock
      .onPost("/api/meetups/")
      .reply(200, { meetup: { ...mocks.meetup.uri } });
  ...
  it("should handle deleteMeetup success", async () => {
    const expectedActions = [{ type: types.DELETE_MEETUP, payload: "uri" }];
  ...
  it("should handle getMeetupEvents success", async () => {
    const expectedActions = [
      { type: types.GET_MEETUP_EVENTS_REQUEST, payload: { meetup: "uri" } },
      {
        ...
        payload: { meetup: "uri", events: { ...mocks.events } },
      },
    ];
  ...
  it("should handle addMeetupEvent()", async () => {
    ...
    const expectedActions = [
      { type: types.ADD_MEETUP_EVENT, payload: event.message },
    ];
  ...
  it("should handle deleteMeetupEvent()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.DELETE_MEETUP_EVENT, payload: event.message },
    ];
  ...
  it("should handle reloadMeetupEvent()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.EDIT_MEETUP_EVENT, payload: event.message },
    ];
  ...
  it("should handle voteMeetupEvent()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.VOTE_EVENT_OPTION, payload: event.message },
    ];
  ...
  it("should handle addMeetupMember()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.ADD_MEETUP_MEMBER, payload: event.message },
    ];
  ...
  it("should handle deleteMeetupMember()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.DELETE_MEETUP_MEMBER, payload: event.message },
    ];
  ...
  it("should handle addEventOption()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.ADD_EVENT_OPTION, payload: event.message },
    ];
  ...
  it("should handle deleteEventOption()", async () => {
    const event = { message: "message" };
    const expectedActions = [
      { type: types.DELETE_EVENT_OPTION, payload: event.message },
    ];
