...
describe('User actions', () => {
    ...
    it ('should handle signup', async () => {
        const expectedActions = [
            {type: types.AUTH_USER, payload: {access: mocks.tokens.access, user: mocks.userWithSettings}}
        ]
    ...
    it ('should handle signout ', async () => {
        const expectedActions = [
            {type: types.CLEAR_STORE, payload: {}}
        ]
    ...
    it ('should handle addSettings success', async () => {
        const expectedActions = [
            ...
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "Successfully saved settings."}}
        ]

        mock.onPost("/api/users/settings/").reply(200, {...mocks.userWithSettings})
    ...
    it ('should handle addSettings error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "Unable to save settings."}}
        ]
    ...
    it ('should handle setUserSettings success', () => {
        ...
        const expectedAction = {type: types.ADD_SETTINGS, payload: {...settings, radius: 25}}

        expect(actions.setUserSettings({...mocks.settings})).toEqual(expectedAction)
    })
    ...
    it ('should handle addPreference success', async () => {
        const expectedActions = [
            ...
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "Successfully added preference"}}
        ]

        mock.onPost("/api/users/1/preferences/").reply(200, {...mocks.preference})
    ...
    it ('should handle addPreference error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "Unable to add preference."}}
        ]
    ...
    it ('should handle editPreference success', async () => {
        ...
        mock.onPatch("/api/users/1/preferences/1/").reply(200, [...mocks.preferences])
    ...
    it ('should handle editPreference error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "Unable to edit preference."}}
        ]
    ...
    it ('should handle reorderPreference success', async () => {
        ...
        mock.onPatch("/api/users/1/preferences/").reply(200, [...mocks.preferences])
    ...
    it ('should handle editPreference error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "Unable to reorder preference."}}
        ]
    ...
    it ('should handle deletePreference success', async () => {
        const expectedActions = [
            ...
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "success", message: "Successfully deleted preference"}}
        ]

        mock.onDelete("/api/users/1/preferences/1/").reply(200, [...mocks.preferences])
    ...
    it ('should handle deletePreference error', async () => {
        const expectedActions = [
            {type: types.ADD_GLOBAL_MESSAGE, payload: {type: "error", message: "Unable to delete preference."}}
        ]
