...
import {user, error, settings, friends, friend, friendInvite, preferences, preference} from '../../mocks/index'
...
describe('User Reducer', () => {
    ...
    it('should handle AUTH_USER', () => {
        ...
        const expectedState = {...userDefaultState, user, authenticated: "something"}
    ...
    it('should handle SIGNUP_ERROR', () => {
        ...
        const newState = userReducer(userDefaultState, action)
        const expectedState = {...userDefaultState, signupErrorMessage: error.message}
        expect(newState).toEqual(expectedState)
    })
    ...
    it('should handle LOGIN_ERROR', () => {
        ...
        const newState = userReducer(userDefaultState, action)
        const expectedState = {...userDefaultState, loginErrorMessage: error.message}
        expect(newState).toEqual(expectedState)
    })
    ...
    it('should handle ADD_SETTINGS', () => {
        ...
        const expectedState = {...userDefaultState, user: {...user, settings: {...settings}}}
        expect(newState).toEqual(expectedState)
    })
    ...
    it('should handle ADD_FRIEND', () => {
        ...
        const newState = userReducer(state, action)
        const expectedState = {...userDefaultState, friends: [...friends, friend]}
        expect(newState).toEqual(expectedState)
    })
    ...
    it('should handle ADD_PREFERENCE', () => {
        ...
        const newState = userReducer(state, action)
        const expectedState = {...userDefaultState, preferences: [...preferences, preference]}
        expect(newState).toEqual(expectedState)
    })
