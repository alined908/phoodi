    ...
    return (
      <div
        className={`${styles.bar} ${
          this.props.mobile && this.props.show ? styles.showContacts : ""
        } elevate`}
      >
          ...
          <div>
            <Tooltip title="Friends">
              <IconButton
                ...
                onClick={() => this.filterRooms("friend")}
                edge="end"
              >
                <PersonIcon />
              </IconButton>
...
ChatBar.propTypes = {
  rooms: PropTypes.arrayOf(chatRoomPropType),
  user: userPropType,
