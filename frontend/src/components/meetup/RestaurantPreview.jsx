...
import {Dialog, Button, DialogActions, DialogContent, DialogTitle, Grid, Tooltip, Avatar, Divider} from '@material-ui/core'
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={6}>
                            <div className={styles.previewInfo}>
                                ...
                                <div>
                                    {info.location.display_address.join(" ")}
                                </div>
                                <div>
                                    {info.price}
                                </div>
